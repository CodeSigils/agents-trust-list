...
- [ANS Registry](https://github.com/agentnameservice/ans-registry) — ANS registry implementation with registration and resolution endpoints.
...
- [AGNTCY Identity](https://github.com/agntcy/identity) — Linux Foundation AGNTCY project. Agent identity onboarding, creation, and verification.
- [OASF Agent Directory MCP](https://github.com/CSOAI-ORG/oasf-agent-directory-mcp) — OASF Agent Directory MCP. Cisco AGNTCY bridge under Linux Foundation.
...
- [TEE-backed Private Memory](https://github.com/Xucion/TEE-backed-Private-Memory-Layer-for-Agents) — TEE-backed private memory layer using Gramine SGX/RA-TLS.
